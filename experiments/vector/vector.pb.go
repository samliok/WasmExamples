...
func (x *IntVector) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IntVector) ProtoMessage() {}

func (x *IntVector) ProtoReflect() protoreflect.Message {
	mi := &file_vector_proto_msgTypes[0]
...
// Deprecated: Use IntVector.ProtoReflect.Descriptor instead.
func (*IntVector) Descriptor() ([]byte, []int) {
	return file_vector_proto_rawDescGZIP(), []int{0}
}

func (x *IntVector) GetValues() []int32 {
	if x != nil {
		return x.Values
	}
	return nil
...
var file_vector_proto_rawDesc = []byte{
	...
	0x76, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x22, 0x23, 0x0a, 0x09, 0x49, 0x6e, 0x74, 0x56, 0x65, 0x63,
	0x74, 0x6f, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x05, 0x52, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x42, 0x0a, 0x5a, 0x08, 0x2e,
	0x2f, 0x76, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_vector_proto_goTypes = []interface{}{
	(*IntVector)(nil), // 0: vector.IntVector
}
